...
export const Cart = () => {
    ...
    const realizarCompra = () => {
        setLoader(true)
        const valueNombre = document.getElementById("nombreOrder")
        const nombreComprador = valueNombre.value
        ...
        <Fragment>
                    ...
                    {existe ? 
                        cart.map((valor) =>{
                            return(
                                ...
                                <td><strong>$ {valor.precio * valor.cantidad}</strong></td>
            ...
            <div className='divOrder'>
                <div className='subDivOrder'>
                    ...
                    <div>
                        <label className='labelOrder'>Nombre completo: </label>
                        <input className='inputOrder' type="text" id="nombreOrder" placeholder="" required/>
                    </div>
                    {/* <div>
                        <label className='labelOrder'>Correo: </label>
                        <input className='inputOrder' type="text" id="correoOrder" placeholder="correo@gmail.com" required/>
                    </div> */}
                    
                    <input className='item-boton' onClick={() => realizarCompra()} type="submit" value="¡Listo!"/>
                    {loader && <Loader />}
                    {orderId && <p>Tu orden es: <span style={{color: "black"}}>{orderId}</span></p>}
                </div>
